...
results <- read_excel(paste0(path, "results.xlsx"))
...
ggsave(paste0("overall", image_type),
       plot = en_plot,
       path=paste0(path, "only_RO//en_figures/"),
       dpi=335,
       width=20.85, height=14.05, units="cm")
...
ggsave(paste0("overall", image_type),
       plot = hu_plot,
       path=paste0(path, "only_RO//hu_figures/"),
       dpi=335,
       width=20.85, height=14.05, units="cm")
...
ggsave(paste0("overall", image_type),
       plot = ro_plot,
       path=paste0(path, "only_RO//ro_figures/"),
       dpi=335,
       width=20.85, height=14.05, units="cm")
...
en_plot <- plot + ggtitle("Standing of Klaus Iohannis before the Ist Round")  +
  geom_text(aes(x=as.Date("2019-10-1"), y=results$I_round_national_percent[results$Candidate=="Iohannis"]+0.4,
                label="National vote share"), color="black") +
  geom_text(aes(x=as.Date("2019-10-1"), y=results$I_round_total_percent[results$Candidate=="Iohannis"]+0.4,
...
en_plot <- plot + ggtitle(paste0("Standing of ", Dancila, ", Barna, and Diaconu before the Ist Round")) +
  ...
  geom_text(aes(x=as.Date("2019-11-11"), y=4, label="Election day"), color="black", angle = 90)
...
hu_plot <- plot + ggtitle(paste0(Dancila, ", Barna, és Diaconu állása az els", sprintf('\u0151'), " forduló el", sprintf('\u0151'), "tt")) +
  ...
  geom_text(aes(x=as.Date("2019-11-11"), y=4, label="Választási nap"), color="black", angle = 90)
...
ro_plot <- plot + ggtitle(paste0(Dancila, ", Barna, și Diaconu înainte de turul I.")) +
  ...
  geom_text(aes(x=as.Date("2019-11-11"), y=4, label="Ziua alegerilor"), color="black", angle = 90)
...
en_plot <- plot + ggtitle(paste0("Standing of ", Dancila, " before the Ist Round")) +
  geom_text(aes(x=as.Date("2019-08-15"), y=results$I_round_national_percent[results$Candidate=="Dancila"]-0.4,
                label="National vote share"), color="black") +
  geom_text(aes(x=as.Date("2019-08-15"), y=results$I_round_total_percent[results$Candidate=="Dancila"]-0.4,
                label="Final vote share"), color="black") 
...
en_plot <- plot + ggtitle(paste0("Standing of Barna before the Ist Round")) +
  geom_text(aes(x=as.Date("2019-08-07"), y=results$I_round_national_percent[results$Candidate=="Barna"]-0.3,
                label="National vote share"), color="black") +
  geom_text(aes(x=as.Date("2019-08-07"), y=results$I_round_total_percent[results$Candidate=="Barna"]+0.3,
                label="Final vote share"), color="black") 
...
hu_plot <- plot + ggtitle(paste0("Barna állása az els", sprintf('\u0151'), " forduló el", sprintf('\u0151'), "tt")) +  geom_text(aes(x=as.Date("2019-08-07"), y=results$I_round_national_percent[results$Candidate=="Barna"]-0.3,
                label="Országos eredmény"), color="black") +
  geom_text(aes(x=as.Date("2019-08-07"), y=results$I_round_total_percent[results$Candidate=="Barna"]+0.3,
                label="Végleges eredmény"), color="black")
...
en_plot <- plot + ggtitle(paste0("Standing of Diaconu before the Ist Round")) +
  geom_text(aes(x=as.Date("2019-08-15"), y=results$I_round_national_percent[results$Candidate=="Diaconu"]+0.3,
                label="National vote share"), color="black") +
  geom_text(aes(x=as.Date("2019-08-15"), y=results$I_round_total_percent[results$Candidate=="Diaconu"]+0.3,
                label="Final vote share"), color="black") 
...
hu_plot <- plot + ggtitle(paste0("Diaconu állása az els", sprintf('\u0151'), " forduló el", sprintf('\u0151'), "tt")) + geom_text(aes(x=as.Date("2019-08-15"), y=results$I_round_national_percent[results$Candidate=="Diaconu"]+0.3,
                label="Országos eredmény"), color="black") +
  geom_text(aes(x=as.Date("2019-08-15"), y=results$I_round_total_percent[results$Candidate=="Diaconu"]+0.3,
                label="Végleges eredmény"), color="black")
...
en_plot <- plot + ggtitle(paste0("Standing of Paleologu before the Ist Round")) +
  geom_text(aes(x=as.Date("2019-08-15"), y=results$I_round_national_percent[results$Candidate=="Paleologu"]+0.15,
                label="National vote share"), color="black") +
  geom_text(aes(x=as.Date("2019-08-15"), y=results$I_round_total_percent[results$Candidate=="Paleologu"]-0.15,
                label="Final vote share"), color="black") 
...
hu_plot <- plot + ggtitle(paste0("Paleologu állása az els", sprintf('\u0151'), " forduló el", sprintf('\u0151'), "tt")) + geom_text(aes(x=as.Date("2019-08-15"), y=results$I_round_national_percent[results$Candidate=="Paleologu"]+0.15,
                label="Országos eredmény"), color="black") +
  geom_text(aes(x=as.Date("2019-08-15"), y=results$I_round_total_percent[results$Candidate=="Paleologu"]-0.15,
                label="Végleges eredmény"), color="black")
...
en_plot <- plot + ggtitle(paste0("Standing of Kelemen before the Ist Round")) +
  geom_text(aes(x=as.Date("2019-08-20"), y=results$I_round_national_percent[results$Candidate=="Kelemen"]+0.15,
                label="National vote share"), color="black") +
  geom_text(aes(x=as.Date("2019-08-20"), y=results$I_round_total_percent[results$Candidate=="Kelemen"]+0.15,
                label="Final vote share"), color="black")
...
hu_plot <- plot + ggtitle(paste0("Kelemen állása az els", sprintf('\u0151'), " forduló el", sprintf('\u0151'), "tt")) + geom_text(aes(x=as.Date("2019-08-20"), y=results$I_round_national_percent[results$Candidate=="Kelemen"]+0.15,
                label="Országos eredmény"), color="black") +
  geom_text(aes(x=as.Date("2019-08-20"), y=results$I_round_total_percent[results$Candidate=="Kelemen"]+0.15,
                label="Végleges eredmény"), color="black")
...
sd2 <- dat %>% 
  select(`Klaus Iohannis`, `Viorica Dăncilă`, `Dan Barna`, `Mircea Diaconu`, `Polling company`) %>% 
  gather(key = "key", value="value", -`Polling company`) %>% 
  mutate(results=ifelse(key=="Dan Barna", 14.69294487,
                        ifelse(key=="Mircea Diaconu", 8.703118569,
                               ifelse(key=="Klaus Iohannis", 37.1250522, 21.91933015)))) %>% 
  group_by(`Polling company`, key) %>% 
  filter(!is.na(value)) %>% 
  mutate(n = n()) %>% 
  mutate(sddev=sqrt(sum((value-results)^2)/n)) %>% 
...
sd <- gather(sd, key="type", value="value", -key)

sd$type <- ifelse(sd$type=="overall", "final vote share", "national vote share")
...
sd$type <- ifelse(sd$type=="final vote share", "végleges eredményekhez", "országos eredményekhez")
...
sd$type <- ifelse(sd$type=="végleges eredményekhez", "rezultatele finale", "rezultatele naționale")

ro_plot <- ggplot(sd) +
  geom_bar(aes(y=value, x=reorder(key, value), fill=type), stat="identity", position = "dodge") +
  coord_flip() + ggtitle(paste0("Eroare Medie după sursa Sondajelor")) +
