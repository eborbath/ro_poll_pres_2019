...
results <- read_excel(paste0(path, "official_results\\results.xlsx"))
...
```
# same meassure for the companies in 2014, only taking the national level results
...
polls14 <- read_excel(paste0(path, "polls_2014//polls_2014.xlsx"))
