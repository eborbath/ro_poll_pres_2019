...
predicted[21,]$`Fieldwork end data`<- as.Date("2019-11-10")
...
plot <- ggplot(predicted, aes(x=`Fieldwork end data`)) +
  ...
  scale_x_date(breaks=c(as.Date("2019-08-10"), as.Date("2019-09-10"),
                                      as.Date("2019-10-10"), as.Date("2019-11-10")),
